...
const inputPath = './public/images/hero/hero-new-original.png';
const outputDir = './public/images/hero';

async function optimizeNewHeroImage() {
  try {
    console.log('Optimizing new hero image...');

    // Generate WebP versions at different sizes (overwrite existing)
    const sizes = [
    ...
    console.log('\n✅ New hero image optimization complete!');
  } catch (error) {
